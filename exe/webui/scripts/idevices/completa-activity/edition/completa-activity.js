    ...
    createForm: function () {
        ...
        var html = '\
			    <div id="gameQEIdeviceForm">\
                    <div class="exe-idevice-info">'+_("Cree actividades o juegos en los que los alumnos deberán completar los huecos de un texto, escribiéndolo, seleccionándolo de cuadros desplegables o arrastrándolo des botones.")+' <a href="https://youtu.be/aKdBRClanYk" hreflang="es" rel="lightbox">'+_("Aprenda a usar este iDevice.")+'</a></div>\
                    ...
                    ' + $exeAuthoring.iDevice.gamification.instructions.getFieldset(_("Observe the letters, identify and fill in the missing words.")) + '\
                        <fieldset class="exe-fieldset exe-fieldset-closed">\
                            ...
                            <div>\
                                ...
                                <p id="cmptEWordsErrorsDiv" class="CMPT-Hide CMPT-Flex">\
                                    <label for="cmptEWordsErrors">' + _("Palabra incorrectas") + ': <input type="text" id="cmptEWordsErrors"> </label>\
                                </p>\
                                <p>\
